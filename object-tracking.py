...
limitdown=[245,827,935,845]
limitup=[959,831,1621,807]
...
while True:
  ...
  if ret:
    ...
    for result in tracker_dets:
      ...
      if limitup[0] <cx < limitup[2] and limitup[1] -15 <cy < limitup[2] +15:
        if totalcountup.count(id) ==0:
          totalcountup.append(id)
          cv2.line(frame,(limitup[0],limitup[1]),(limitup[2],limitup[3]),(0,255,0),3)
      if limitdown[0] <cx < limitdown[2] and limitdown[1] -15 <cy < limitdown[2] +15:
    ...
    cv2.putText(frame,str("Vehicle Entering") + ":" + str(len(totalcountup)),(1500,91),cv2.FONT_HERSHEY_PLAIN,2,(0,0,255),2)
    cv2.putText(frame,str("Vehicle Leaving") + ":" + str(len(totalcountdown)),(141,91),cv2.FONT_HERSHEY_PLAIN,2,(0,0,255),2)
